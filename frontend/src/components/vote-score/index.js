...
this.resetFocus();
    ...
    render(){
        ...
        return (<div ref={this.sectionFocusEl}>
            <button className={`button bt-like is-success ${this.state.likeActive ? this.state.likeActive : 'is-outlined'}`} onClick={this.onClick} >
                <i className="far fa-thumbs-up" />&nbsp;Like
            </button>&nbsp;
            <button className={`button bt-notlike is-danger ${this.state.notLikeActive ? this.state.notLikeActive : 'is-outlined'}`} onClick={this.onClick} >
                <i className="far fa-thumbs-down" />&nbsp;Not like
            </button>
        </div>);
    }
}
